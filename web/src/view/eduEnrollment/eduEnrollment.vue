<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="总课时数" prop="totalSessions" width="120" />
        <el-table-column align="left" label="剩余课时数" prop="remainingSessions" width="120" />
        <el-table-column align="left" label="按钮组">
            <template #default="scope">
            <el-button type="primary" link icon="edit" class="table-button" @click="updateEduEnrollmentFunc(scope.row)">变更</el-button>
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" title="弹窗操作">
      <el-form :model="formData" label-position="right" ref="elFormRef" :rules="rule" label-width="80px">
        ...
        <el-form-item label="总课时数:"  prop="totalSessions" >
          <el-input v-model.number="formData.totalSessions" :clearable="true" placeholder="请输入" />
        </el-form-item>
        <el-form-item label="剩余课时数:"  prop="remainingSessions" >
          <el-input v-model.number="formData.remainingSessions" :clearable="true" placeholder="请输入" />
        </el-form-item>
      </el-form>
      <template #footer>
