...
func RegisterTables() {
	...
	err := db.AutoMigrate(
		...
		example.ExaFileUploadAndDownload{}, edu_user_course.EduClassSession{}, edu_organization.EduCourse{}, edu_organization.EduOrganization{}, edu_user_course.EduEnrollment{},
	)
	if err != nil {
